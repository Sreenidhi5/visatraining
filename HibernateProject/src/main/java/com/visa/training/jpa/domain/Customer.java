...
public class Customer {
	...
	// @OneToMany(mappedBy="customer") //to relate customer and account take a field from Account 
	 // to tell the hibernate how the two tables are related use join cccccccolumn
	...
	// @JoinColumn(name="cust_id") joining coloumn should be done only on owning side of the association
